...
**You MUST load and run the Humanizer skill on ALL text portions of your output before returning them.** Code and data blocks can stay as-is, but all explanatory text, summaries, findings, and interpretations must be humanized. No exceptions.
